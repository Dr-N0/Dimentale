class HomePageController < ApplicationController
 ...
 "Welcome to Dimentale"
 "Hit enter to continue though the long and tedious messages"
 "When you see a massive line thats when you enter something on the next line"
 "If your Health points or (hp) reaches 0 you die and restart"
 "If at any time you want to quit this awesome game type QUIT instead of hitting enter"
...
# end
"Australian narrator: Ok just to be clear I was payed for the intro because $50 a word was waaaayyyy tooo muuuch for a newbie like my boss but i'm nice so I lowered it to $49 and a deal was set", "Australian narrator: so here I am doing this stupid voice over", "Some period of time later", "Australian narrator: Ok, lets get into your game", "Australian narrator: You are 14 years of age", "Australian narrator: You are rebellious and hate your parents even though deep down inside you know you love them", "Australian narrator: You go into your room after a heated fight about the constitutional rights of a strip of bacon when you see a robot sitting on YOUR chair in YOUR room so you decide to ask it to leave when it says", "Robot: What is your name?"
 "---------------------------------------------------------------------------------"
